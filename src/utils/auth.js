...
const TokenKey = 'AFLC-Token'
const UsernameKey = 'AFLClastloginUsername'
const OrgIdKey = 'AFLCOrganizationId'
const RefreshTokenKey = 'AFLC-refreshtoken'
const UserinfoKey = 'AFLC-userinfo'
