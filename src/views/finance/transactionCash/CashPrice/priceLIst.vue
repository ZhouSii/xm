    ...
    <div class="classify_info">
      <div class="btns_box" v-if="cashtype">
        <el-button
          ...
          v-if="cashtype=='AF09301'&&$_has_permission('FINANCE_WITHDRAW_MANAGE_GENERATIONWITHDRAWAL_TOBEAUDITED_TOEXAMINE')"
        >审核</el-button>
        <el-button
          type="primary"
          icon="el-icon-edit"
          ...
          v-if="cashtype=='AF09601'&&$_has_permission('FINANCE_WITHDRAW_MANAGE_GENERATIONWITHDRAWAL_STAYFU_PAYMENTREGISTRATION')"
        >付款登记</el-button>
        <el-button
          type="primary"
          icon="el-icon-money"
          ...
          v-if="cashtype=='AF09201'&&$_has_permission('FINANCE_WITHDRAW_MANAGE_GENERATIONWITHDRAWAL_WAITINGFORCANCELLATION_WRITEOFF')"
        >核销</el-button>
        <el-button
          type="primary"
          icon="el-icon-coin"
          ...
          v-if="(cashtype=='AF09601'&&$_has_permission('FINANCE_WITHDRAW_MANAGE_GENERATIONWITHDRAWAL_STAYFU_PAYMENTRECORD'))||(cashtype=='AF09201'&&$_has_permission('FINANCE_WITHDRAW_MANAGE_GENERATIONWITHDRAWAL_WAITINGFORCANCELLATION_PAYMENTRECORD'))"
        >付款记录</el-button>
      </div>
