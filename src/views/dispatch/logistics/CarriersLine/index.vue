<template>
    <div class="identicalStyle CarriersLine" v-loading="loading">
        ...
        <div class="classify_info">
            <div class="btns_box">
                <el-button type="primary" icon="el-icon-circle-plus" plain @click="handleClick('new')" :size="btnsize" v-has:DISPATCH_HAIRLOGISTICS_SPECIALLINECARRIER_ADD>新增</el-button>
                <el-button type="primary" :size="btnsize" plain icon="el-icon-edit" @click="handleClick('revise')" v-has:DISPATCH_HAIRLOGISTICS_SPECIALLINECARRIER_MODIFY>修改</el-button>
                <el-button type="primary" :size="btnsize" plain icon="el-icon-bell" @click="handleClick('status')" v-has:DISPATCH_HAIRLOGISTICS_SPECIALLINECARRIER_ENABLEDISABLE>启用/禁用</el-button>
            </div>
            <div class="info_news">
                <el-table
                    ref="multipleTable"
