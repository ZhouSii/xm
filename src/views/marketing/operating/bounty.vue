    ...
    <div class="classify_info">
      <div class="btns_box">
        <el-button
          ...
          v-has:MARKETING_OPERATION_DRIVER_REWARD_EXPORT_EXCEL
        >导出Excel</el-button>
        <span class="description">奖励金金额：{{rewardAmountSum}}</span>
        <span class="description">查询奖励金金额：{{searchRewardAmount}}</span>
      </div>
      <div class="info_news">
        <!-- tabel内容 -->
        <el-table
        ...
        >
          ...
          <el-table-column prop="driver" :show-overflow-tooltip="true" label="车主" sortable></el-table-column>
          <el-table-column prop="carType" :show-overflow-tooltip="true" label="车型" sortable></el-table-column>
          <el-table-column
            prop="totalAmount"
        ...
        <!-- 页码 -->
        <div class="info_tab_footer" v-has:MARKETING_OPERATION_DRIVER_REWARD_LIST>
          共计:{{ dataTotal }}
...
import {
  postUserRewardDriverTransaction,
  userRewardDriverTransactionExcel
      ...
      switch (type) {
        ...
        case "outExce":
          if (!this.searchInfo.startTime) {
            ...
            userRewardDriverTransactionExcel(0, 0, this.searchInfo).then(
              res => {
