  ...
  <div class="identicalStyle placeOrderCodeReword" v-loading="loading">
    ...
    >
      ...
      <el-form-item label="下单码所属货主" prop="orderCodeOwnerNameOrPhone">
        <el-input
          v-model="listSystemObj.vo.orderCodeOwnerNameOrPhone"
          clearable
          placeholder="手机号/姓名"
        ></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    firstblood() {
      this.loading = true;
      lclOrderCodeList(this.listSystemObj)
        .then(res => {
    ...
    importExcel() {
      ...
      lclOrderCodeListExcel(0, 0, this.listSystemObj.vo).then(res => {
        var blob = new Blob([res]);
        this.href = window.URL.createObjectURL(blob);
        var NewDom = document.createElement("a");
        NewDom.setAttribute("href", this.href);
        NewDom.setAttribute("target", "_blank");
        NewDom.setAttribute("download", "发物流下单码奖励.xls");
