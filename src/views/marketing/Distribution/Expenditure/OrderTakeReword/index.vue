    ...
    <div class="classify_info">
      <div class="btns_box">
        <el-button
          ...
          :size="btnsize"
          @click="importExcel"
          v-has:MARKETING_DISTRIBUTION_EXPENCE_ORDER_REWARD_EXPORT_EXCEL
        >导出EXCEL</el-button>
      </div>
      <div class="info_news">
        <el-table
...
export default {
  ...
  methods: {
    ...
    firstblood() {
      this.loading = true;
      receiveCodeList(this.listSystemObj)
        .then(res => {
    ...
    importExcel() {
      ...
      receiveCodeListExcel(0, 0, this.listSystemObj.vo).then(
        res => {
          ...
          NewDom.setAttribute("download", "接单码奖励.xls");
