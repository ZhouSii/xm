<template>
  <div class="identicalStyle ShipperBusinessReword" v-loading="loading">
    ...
    >
      <el-form-item label="发货地" prop="orderAreaName">
        <el-input v-model="listSystemObj.vo.orderAreaName" clearable></el-input>
      </el-form-item>
      <el-form-item label="奖励发放时间" prop="chooseTime">
        <el-date-picker
          v-model="chooseTime"
          type="daterange"
          range-separator="-"
      ...
      <el-form-item label="货主推荐人" prop="userRecommenderPhoneOrNameOrPlateNumber">
        <el-input
          v-model="listSystemObj.vo.userRecommenderPhoneOrNameOrPlateNumber"
          clearable
          placeholder="手机号/姓名/车牌号"
        ></el-input>
      </el-form-item>
      <el-form-item label="运单号" prop="orderNum">
    ...
    <div class="classify_info">
      <div class="btns_box">
        <el-button
          ...
          :size="btnsize"
          @click="importExcel"
          v-has:MARKETING_DISTRIBUTION_EXPENCE_SHIPPER_BUSINESS_REWARD_EXPORT_EXCEL
        >导出EXCEL</el-button>
      </div>
      <div class="info_news">
        <el-table
    ...
    <div class="info_tab_footer" v-has:MARKETING_DISTRIBUTION_EXPENCE_SHIPPER_BUSINESS_REWARD_LIST>
      共计:{{ totalCount }}
...
import {
  lclShipperBusinessRewordList,
  lclShipperBusinessRewordListExcel
...
export default {
      ...
      tableColumn: [
        ...
        },
        {
          ...
          click: function(row) {
            ...
            this.$router.push({
              name: "发物流订单详情",
              query: { orderSerial: row.orderNum }
            });
          }.bind(this),
          slot: scope => {
  ...
  methods: {
    ...
    handleSearch(type) {
      this.listSystemObj.vo.tradeStartTime = this.chooseTime
        ? this.chooseTime[0]
        : "";
      this.listSystemObj.vo.tradeEndTime = this.chooseTime
        ? this.chooseTime[1]
        : "";
      if (type == "clear") {
    ...
    firstblood() {
      this.loading = true;
      lclShipperBusinessRewordList(this.listSystemObj)
        .then(res => {
    ...
    importExcel() {
      ...
      lclShipperBusinessRewordListExcel(0, 0, this.listSystemObj.vo).then(
        res => {
          ...
          NewDom.setAttribute("download", "发物流推荐货主业务奖励.xls");
