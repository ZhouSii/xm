...
import { RecommendUsersOrderTotal,RecommendUsersOrderTotalExcel } from "@/api/marketing/distribution";
...
export default {
  ...
  methods: {
    ...
    firstblood() {
      this.loading = true;
      RecommendUsersOrderTotal(this.listSystemObj)
        .then(res => {
    ...
    importExcel() {
      ...
      RecommendUsersOrderTotalExcel(0, 0, this.listSystemObj.vo).then(res => {
        var blob = new Blob([res]);
        this.href = window.URL.createObjectURL(blob);
        var NewDom = document.createElement("a");
        NewDom.setAttribute("href", this.href);
        NewDom.setAttribute("target", "_blank");
        NewDom.setAttribute("download", "小货车推荐用户订单汇总.xls");
