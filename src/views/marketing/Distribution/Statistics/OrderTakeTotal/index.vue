    ...
    <div class="classify_info">
      <div class="btns_box">
        <el-button
          ...
          :size="btnsize"
          @click="importExcel"
          v-has:MARKETING_DISTRIBUTION_STATISTICAL_ORDER_SUM_EXPORT_EXCEL
        >导出EXCEL</el-button>
      </div>
      <div class="info_news">
        <el-table
...
export default {
  ...
  methods: {
    ...
    firstblood() {
      this.loading = true;
      OrderTakeTotal(this.listSystemObj)
        .then(res => {
    ...
    importExcel() {
      ...
      OrderTakeTotalExcel(0, 0, this.listSystemObj.vo).then(res => {
        var blob = new Blob([res]);
        this.href = window.URL.createObjectURL(blob);
        var NewDom = document.createElement("a");
        NewDom.setAttribute("href", this.href);
        NewDom.setAttribute("target", "_blank");
        NewDom.setAttribute("download", "接单码接单汇总.xls");
