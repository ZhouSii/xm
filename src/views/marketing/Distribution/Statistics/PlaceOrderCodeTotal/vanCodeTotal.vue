...
export default {
  ...
  methods: {
    ...
    firstblood() {
      this.loading = true;
      PlaceOrderCodeTotal(this.listSystemObj)
        .then(res => {
    ...
    importExcel() {
      ...
      PlaceOrderCodeListExcel(0, 0, this.listSystemObj.vo).then(
        res => {
          ...
          NewDom.setAttribute("download", "小货车下单码下单汇总.xls");
