<template>
    <div class="identicalStyle firstTrialAllCompnent" v-loading="loading">
        <el-form  :inline="true" :model="listSystemObj.vo" ref="ruleForm" class="demo-ruleForm classify_searchinfo">
            ...
            <el-form-item label="初审状态" prop="status">
    ...
    data() {
        return {
            ...
            listSystemObj:{
                ...
                "pageSize": 20,
                "vo": {
                    status:'',//【待初审审核】显示：待初审审核（AF0880601） 【初审已审核】显示：初审通过（AF0880602）、初审驳回（AF0880603）、初审不通过（AF0880604）
