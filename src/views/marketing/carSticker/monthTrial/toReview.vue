<template>
    <div class="identicalStyle toReviewCompnent" v-loading="loading">
        ...
        <div class="classify_info">
            <div class="btns_box">
                <el-button type="primary" icon="el-icon-circle-plus" plain @click="handleClick('ex')" :size="btnsize" v-has:MARKETING_CARSTICKER_MONTHLYREVIEW_PENDINGREVIEW_EXAMINE>复审</el-button>
                ...
                switch (type) {
                    ...
                    case 'export':
                        ...
                        exportMonthTrialList(this.listSystemObj).then(res => {
                            ...
                            NewDom.setAttribute('download', '月审待复审'+parseTime(timestamp)+'.xlsx');
