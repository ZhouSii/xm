<template>
  <div class="StyleNewinfoComponent shippercreatDialog commoncss driverDialog">
    <el-button
      ...
      @click="openDialog()"
      size="mini"
      :class="editType=='view'?'BtnInfo':''"
    >
      <span>{{btntext}}</span>
    </el-button>
    <el-dialog
      :title="btntitle"
      :visible="driverTemplateDialogFlag"
      top="5vh"
      :before-close="change"
    ...
    >
      <div>
        <el-form ref="templateModel" :model="templateModel" :rules="rulesForm">
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item
                ...
                :prop="editType=='edit2'?'':'driverName'"
              >
                <el-input
                  v-model="templateModel.driverName"
                  :maxlength="20"
            ...
            <el-col :span="8">
              <el-form-item
                label="手机号码："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'driverMobile'"
              >
                <el-input
                  v-model="templateModel.driverMobile"
                  :maxlength="11"
                  :disabled="editType=='view'||editType=='valetAuth'||editType=='edit'"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item
                label="身份证号码："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'cardid'"
              >
                <el-input
                  v-model="templateModel.cardid"
                  :maxlength="18"
                  :disabled="editType=='view'"
                ></el-input>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item
                label="性别："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'sex'"
              >
                <el-select
                  v-model="templateModel.sex"
                  placeholder="请选择"
                  :disabled="editType=='view'"
                >
                  <el-option
            ...
            <el-col :span="8">
              <el-form-item
                label="年龄："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'age'"
              >
                <el-input
                  v-model.number="templateModel.age"
                  :maxlength="3"
                  :disabled="editType=='view'"
                ></el-input>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item
                label="认证所在地："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'belongCityName'"
              >
                <el-input
                  v-model="templateModel.belongCityName"
                  @focus="changeSelect_one"
                  :disabled="editType=='view'"
                  v-if="editType !=='add'&&!selectFlag_one"
                ></el-input>
                <vregion
                  :ui="true"
                  @values="regionChange"
            ...
            <el-col :span="8">
              <el-form-item label="活跃值：" :label-width="formLabelWidth">
                <el-select
                  v-model="templateModel.activeValue"
                  placeholder="请选择"
                  :disabled="editType=='view'"
                >
                  <el-option
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item
                label="注册所在地："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'regisAddress'"
              >
                <el-input
                  v-model="templateModel.regisAddress"
                  @focus="changeSelect_two"
                  :disabled="editType=='view'"
                  v-if="editType !=='add'&&!selectFlag_two"
                ></el-input>
                <vregion
                  :ui="true"
                  @values="regisaddressChange"
                  class="form-control"
                  ref="regisAddress"
                  v-else
                >
            ...
            <el-col :span="8">
              <el-form-item label="住址：" :label-width="formLabelWidth">
                <el-input v-model="templateModel.address" :disabled="editType=='view'"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="最后登录时间："
                :label-width="formLabelWidth"
              >{{templateModel.loginTime|parseTime}}</el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="是否临时认证：" :label-width="formLabelWidth">
                <el-button
                  ...
                  icon="el-icon-circle-check-outline"
                  :size="UseBtntype"
                  @click="isTempCertificate(0)"
                  v-if="templateModel.isTempCertificate=='1'"
                  :disabled="editType=='view'"
                >是</el-button>
                <el-button
                  type="info"
            ...
            <el-col :span="8">
              <el-form-item label="是否业务员：" :label-width="formLabelWidth">
                <el-button
                  ...
                  icon="el-icon-circle-check-outline"
                  :size="UseBtntype"
                  @click="isCompanySale(0)"
                  v-if="templateModel.isCompanySale=='1'"
                  :disabled="editType=='view'"
                >是</el-button>
                <el-button
                  type="info"
          ...
          <el-row>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="认证状态："
                :label-width="formLabelWidth"
              >{{templateModel.driverStatusName}}</el-form-item>
            </el-col>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="注册日期："
                :label-width="formLabelWidth"
              >{{templateModel.registerTime|parseTime}}</el-form-item>
            </el-col>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="注册渠道："
                :label-width="formLabelWidth"
              >{{templateModel.registerOriginName}}</el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="提交认证时间："
                :label-width="formLabelWidth"
              >{{templateModel.authenticationTime|parseTime}}</el-form-item>
            </el-col>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="等待时长："
                :label-width="formLabelWidth"
              >{{templateModel.authenticationTime|remainData}}</el-form-item>
            </el-col>
            <el-col :span="8" v-if="editType!== 'add'">
              <el-form-item
                label="首次认证通过时间："
                :label-width="formLabelWidth"
              >{{templateModel.firstAuthPassTime|parseTime}}</el-form-item>
            </el-col>
          </el-row>
              ...
              <el-form-item prop="idCardFile" label-width="0">
                <div class="uploadPicture">
                  <h3 class="uploadH3">
                    ...
                    <el-button
                      type="primary"
                      class="showPictureBtn"
                      plain
                      v-if="editType != 'view' && templateModel.idCardFile"
                      @click="showCurrenPic('idCardFile')"
                    >查看</el-button>
                  </h3>
                  <span v-if="editType == 'view'">
                    <div class="uploadImgBox" v-viewer>
                      <el-tooltip class="item" effect="dark" content="双击图片查看原图" placement="top">
                        <img
                          :src="templateModel.idCardFile ? templateModel.idCardFile : defaultImg"
                        />
                      </el-tooltip>
                    </div>
                  </span>
                  <div class="upload_True" v-else>
                    <upload
                      ...
                      v-model="templateModel.idCardFile"
                      uploadType="idCardFile"
                      @getInformation="IdCardInmation"
                    />
                  </div>
                </div>
              </el-form-item>
                ...
                <div class="uploadPicture">
                  <h3 class="uploadH3">
                    ...
                    <el-button
                      ...
                      class="showPictureBtn"
                      plain
                      v-if="editType != 'view' && templateModel.personalImageFile"
                      @click="showCurrenPic('personalImageFile')"
                    >查看</el-button>
                  </h3>
                  <span v-if="editType == 'view'">
                    <div class="uploadImgBox" v-viewer>
                      <el-tooltip class="item" effect="dark" content="双击图片查看原图" placement="top">
                        <img
                          :src="templateModel.personalImageFile ? templateModel.personalImageFile : defaultImg"
                        />
                      </el-tooltip>
                    </div>
                  </span>
                  <div class="upload_True" v-else>
                    <upload
                      class="licensePicture"
                      tip="（必须为jpg/png并且小于5M）"
                      v-model="templateModel.personalImageFile"
                      pictureStatus="true"
                    />
                  </div>
                </div>
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item
                label="档案编号："
                :label-width="formLabelWidth"
                :prop="editType=='edit2'?'':'fileNumberLicense'"
              >
                ...
                <div class="uploadPicture">
                  <h3 class="uploadH3">
                    ...
                    <el-button
                      ...
                      class="showPictureBtn"
                      plain
                      v-if="editType != 'view' && templateModel.drivingLicenceFile"
                      @click="showCurrenPic('drivingLicenceFile')"
                    >查看</el-button>
                  </h3>
                  <span v-if="editType == 'view'">
                    <div class="uploadImgBox" v-viewer>
                      <el-tooltip class="item" effect="dark" content="双击图片查看原图" placement="top">
                        <img
                          :src="templateModel.drivingLicenceFile ? templateModel.drivingLicenceFile : defaultImg"
                        />
                      </el-tooltip>
                    </div>
                  </span>
                  <div class="upload_True" v-else>
                    <upload
                      class="licensePicture"
                      tip="（必须为jpg/png并且小于5M）"
                      v-model="templateModel.drivingLicenceFile"
                      uploadType="drivingLicenceFile"
                      @getInformation="drivingLicenceFileInmation"
                    />
                  </div>
                </div>
              </el-form-item>
                ...
                <div class="uploadPicture">
                  <h3 class="uploadH3">
                    ...
                    <el-button
                      ...
                      class="showPictureBtn"
                      plain
                      v-if="editType != 'view' && templateModel.drivingLicenceFileOpposite"
                      @click="showCurrenPic('drivingLicenceFileOpposite')"
                    >查看</el-button>
                  </h3>
                  <span v-if="editType == 'view'">
                    <div class="uploadImgBox" v-viewer>
                      <el-tooltip class="item" effect="dark" content="双击图片查看原图" placement="top">
                        <img
                          :src="templateModel.drivingLicenceFileOpposite ? templateModel.drivingLicenceFileOpposite : defaultImg"
                        />
                      </el-tooltip>
                    </div>
                  </span>
                  <div class="upload_True" v-else>
                    <upload
                      class="licensePicture"
                      tip="（必须为jpg/png并且小于5M）"
                      v-model="templateModel.drivingLicenceFileOpposite"
                    />
                  </div>
                </div>
              </el-form-item>
          ...
          <!-- 新增 / 未认证状态的代客认证/修改-->
          <div v-if="editType=='add' || driverStatus=='AF0010401'">
            <el-row>
              <el-col :span="8">
                <el-form-item
                  label="车牌号："
          ...
          return carNumberValidator(rule, value, callback)
          }, trigger: 'change'}"
                >
                  <el-input
                    v-model="templateModel.carNumber"
                    :maxlength="8"
                    :disabled="editType=='view'"
                  ></el-input>
                </el-form-item>
                <el-form-item label="车牌号：" :label-width="formLabelWidth" v-else>
              ...
              <el-col :span="8">
                <el-form-item
                  label="所有人："
                  :label-width="formLabelWidth"
                  :prop="editType=='eidt2'?'':'owner'"
                  :rules="{required:editType!=='edit2',message:'所有人不能为空',trigger:'change'}"
                >
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="行驶证档案编号：" :label-width="formLabelWidth">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item
                  label="车辆类型："
                  :label-width="formLabelWidth"
                  :prop="editType=='eidt2'?'':'carType'"
                  :rules="{required:editType!=='edit2',message:'车辆类型不能为空',trigger:'change'}"
                >
                  <el-select
                    v-model="templateModel.carType"
                    placeholder="请选择"
                    :disabled="editType=='view'"
                    :class="editType=='valetAuth_un'?'carTypeFlag':''"
                  >
                    <el-option
                  ...
                  <el-checkbox
                    v-model="carTypeChecked"
                    class="carTypeStyle"
                    v-if="editType=='valetAuth_un'"
                  ></el-checkbox>
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8" class="lessWidth_col">
                <el-form-item
                  ...
                  v-if="editType!=='edit2'"
                  :rules="{required:true,validator:(rule, value, callback)=>{
          return carBreadth(rule, value, callback)
          }, trigger: 'change'}"
                >
                  <el-input
                    class="lessWidth"
                ...
                <el-form-item label="车长(米)：" :label-width="formLabelWidth" v-else>
                  <el-input
                    class="lessWidth"
                    placeholder="长"
                    v-model="templateModel.carLength"
                  ...
                  <div class="uploadPicture">
                    ...
                    <div class="upload_True" v-else>
                      <upload
                        class="licensePicture"
                        tip="（必须为jpg/png并且小于5M）"
                        v-model="templateModel.drivingPermitFile"
                        uploadType="drivingPermitFile"
                        @getInformation="drivingPermitFileInmation"
                      />
                    </div>
                  </div>
                </el-form-item>
                  ...
                  <div class="uploadPicture">
                    ...
                    <div class="upload_True" v-else>
                      <upload
                        class="licensePicture"
                        tip="（必须为jpg/png并且小于5M）"
                        v-model="templateModel.drivingPermitFileOpposite"
                      />
                    </div>
                  </div>
                </el-form-item>
          ...
          <div v-else>
            <el-row>
              <el-table
                :data="templateModel.driverPermitList"
                border
                row-key="id"
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item
                          label="车牌号："
                          :label-width="formLabelWidth"
                          v-if="editType!=='edit2'&&props.$index==0"
                          :prop="'driverPermitList[' + props.$index + '].carNumber'"
                          :rules="{required:true,validator:(rule, value, callback)=>{
          return carNumberValidator(rule, value, callback)
          }, trigger: 'change'}"
                        >
                        ...
                        <el-form-item label="车牌号：" :label-width="formLabelWidth" v-else>
                          <el-input
                            auto-complete="off"
                            v-model="props.row.carNumber"
                            :disabled="editType=='view'|| props.$index!==0"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item
                          label="所有人："
                          :label-width="formLabelWidth"
                          :prop="editType=='edit2'&&props.$index!==0?'':'driverPermitList[' + props.$index + '].owner'"
                          :rules="{required:editType!=='edit2'&&props.$index==0,message:'所有人不能为空',trigger:'change'}"
                        >
                          <el-input
                            auto-complete="off"
                            v-model="props.row.owner"
                            :disabled="editType=='view'||(props.$index!==0&&editType!=='view')"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item
                          label="车辆类型："
                          :label-width="formLabelWidth"
                          :prop="editType=='edit2'&&props.$index!==0?'':'driverPermitList[' + props.$index + '].carType'"
                          :rules="{required:editType!=='edit2'&&props.$index==0,message:'车辆类型不能为空',trigger:'change'}"
                        >
                          <el-select
                            v-model="props.row.carType"
                            placeholder="请选择"
                            :disabled="editType=='view'||(props.$index!==0&&editType!=='view')"
                          >
                            <el-option
                      ...
                      <el-col :span="8" class="lessWidth_col">
                        <div v-if="editType!=='edit2'&&props.$index==0">
                          <el-form-item
                            label="车长(米)："
                            :prop="'driverPermitList[' + props.$index + '].carLength'"
                            :rules="{required:true,validator:(rule, value, callback)=>{
          return carBreadth(rule, value, callback)
          }, trigger: 'change'}"
                            :label-width="formLabelWidth"
                          ...
                          <el-form-item
                            :prop="'driverPermitList[' + props.$index + '].carWidth'"
                            :rules="{required:true,validator:(rule, value, callback)=>{
          return carBreadth(rule, value, callback)
          }, trigger: 'change'}"
                          >
                          ...
                          <el-form-item
                            :prop="'driverPermitList[' + props.$index + '].carHeight'"
                            :rules="{required:true,validator:(rule, value, callback)=>{
          return carBreadth(rule, value, callback)
          }, trigger: 'change'}"
                          >
                    ...
                    <el-row :gutter="20">
                      <el-col :span="8" class="CheckPass">
                        <el-form-item
                          :prop="editType=='edit2'&&props.$index!==0?'':'driverPermitList[' + props.$index + '].drivingPermitFile'"
                          :rules="{required:editType!=='edit2'&&props.$index==0,message:'车辆行驶证需要上传',trigger:'change'}"
                        >
                          <div class="uploadPicture">
                            <h3 class="uploadH3">
                              车辆行驶证
                              <el-button
                                ...
                                class="showPictureBtn"
                                plain
                                v-if="editType != 'view' && props.row.drivingPermitFile"
                                @click="showCurrenPic('drivingPermitFile',props.$index)"
                              >查看</el-button>
                            </h3>
                            <div v-if="editType == 'view'">
                              <div class="uploadImgBox" v-viewer>
                                ...
                                >
                                  <img
                                    :src="props.row.drivingPermitFile ? props.row.drivingPermitFile : defaultImg"
                                  />
                                </el-tooltip>
                              </div>
                            </div>
                            <div class="upload_True" v-else>
                              <upload
                                class="licensePicture"
                                tip="（必须为jpg/png并且小于5M）"
                                v-model="props.row.drivingPermitFile"
                                uploadType="drivingPermitFile"
                                @getInformation="drivingPermitFileInmation"
                                v-if="props.$index==0"
                              />
                      ...
                      <el-col :span="8" class="CheckPass">
                        <el-form-item
                          :prop="editType=='edit2'&&props.$index!==0?'':'driverPermitList[' + props.$index + '].drivingPermitFileOpposite'"
                          :rules="{required:editType!=='edit2'&&props.$index==0,message:'车辆行驶证副本需要上传',trigger:'change'}"
                        >
                          <div class="uploadPicture">
                            <h3 class="uploadH3">
                              车辆行驶证副本
                              <el-button
                                ...
                                class="showPictureBtn"
                                plain
                                v-if="editType != 'view' && props.row.drivingPermitFileOpposite"
                                @click="showCurrenPic('drivingPermitFileOpposite',props.$index)"
                              >查看</el-button>
                            </h3>
                            <div v-if="editType == 'view'">
                              <div class="uploadImgBox" v-viewer>
                                ...
                                >
                                  <img
                                    :src="props.row.drivingPermitFileOpposite ? props.row.drivingPermitFileOpposite : defaultImg"
                                  />
                                </el-tooltip>
                              </div>
                            </div>
                            <div class="upload_True" v-else>
                              <upload
                                class="licensePicture"
                                tip="（必须为jpg/png并且小于5M）"
                                v-model="props.row.drivingPermitFileOpposite"
                                v-if="props.$index==0"
                              />
                              <img
                                :src="props.row.drivingPermitFileOpposite ? props.row.drivingPermitFileOpposite : defaultImg"
                      ...
                      <el-col :span="8" class="CheckPass">
                        <el-form-item
                          :prop="editType=='edit2'&&props.$index!==0?'':'driverPermitList[' + props.$index + '].carFile'"
                          :rules="{required:editType!=='edit2'&&props.$index==0,message:'车辆45°照片需要上传',trigger:'change'}"
                        >
                          <div class="uploadPicture">
                            <h3 class="uploadH3">
                              车辆45°照片
                              <el-button
                                ...
                                class="showPictureBtn"
                                plain
                                v-if="editType != 'view' && props.row.carFile"
                                @click="showCurrenPic('carFile',props.$index)"
                              >查看</el-button>
                            </h3>
                            <span v-if="editType == 'view'">
                              <div class="uploadImgBox" v-viewer>
                                <el-tooltip
                                  ...
                                  placement="top"
                                >
                                  <img :src="props.row.carFile ? props.row.carFile : defaultImg" />
                                </el-tooltip>
                              </div>
                            </span>
                            <div class="upload_True" v-else>
                              <upload
                                class="licensePicture"
                                tip="（必须为jpg/png并且小于5M）"
                                v-model="props.row.carFile"
                                v-if="props.$index==0"
                              />
                              <img
                                :src="props.row.carFile ? props.row.carFile : defaultImg"
                                v-else
                                style="width:100%;height:218px"
                              />
                            </div>
                ...
                <el-table-column prop="auditTime" label="审核时间">
                  <template slot-scope="scope">
                    <span>{{ scope.row.auditTime | parseTime('{y}-{m}-{d} {h}:{i}:{s}')}}</span>
                  </template>
                </el-table-column>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="车主奖励等级：" prop="rewardgrade" :label-width="formLabelWidth">
                <el-select
                  v-model="templateModel.rewardgrade"
                  placeholder="请选择"
                  :disabled="editType=='view'"
                >
                  <el-option
            ...
            <el-col :span="8">
              <el-form-item label="中单等级：" :label-width="formLabelWidth">
                <el-select
                  v-model="templateModel.obtainGrade"
                  placeholder="请选择"
                  :disabled="editType=='view'"
                >
                  <el-option
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="推荐人：" :label-width="formLabelWidth">
                {{templateModel.recommenderName}}
                <span
                  v-if="templateModel.recommenderName&&templateModel.recommenderPhone"
                >-</span>
                {{templateModel.recommenderPhone}}
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item
                label="推荐人用户类型："
                :label-width="formLabelWidth"
              >{{templateModel.recommenderUserTypeCode}}</el-form-item>
            </el-col>
          </el-row>
          <el-col :span="8">
            <el-form-item
              label="推荐渠道："
              :label-width="formLabelWidth"
            >{{templateModel.recommendedChannelName}}</el-form-item>
          </el-col>
          <el-row>
            <el-col :span="8">
              <el-form-item
                label="推荐人所属业务员："
                :label-width="formLabelWidth"
              >{{templateModel.recommenderSalesmanName}}</el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item
                label="被推荐人注册时间："
                :label-width="formLabelWidth"
              >{{templateModel.recommendederRegisterTime|parseTime}}</el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="需要后续跟进状态：" :label-width="formLabelWidth">
                <el-button
                  ...
                  icon="el-icon-circle-check-outline"
                  :size="UseBtntype"
                  @click="driverFollowUp(0)"
                  v-if="templateModel.driverFollowUp=='1'"
                  :disabled="editType=='view'"
                >是</el-button>
                <el-button
                  type="info"
            ...
            <el-col :span="8">
              <el-form-item label="是否广告车：" :label-width="formLabelWidth">
                <el-button
                  ...
                  :size="UseBtntype"
                  @click="isAd(0)"
                  v-if="templateModel.isAd=='1'"
                  :disabled="editType=='view' || editType=='edit' || editType=='edit2' || editType=='valetAuth_un' || editType=='valetAuth_up'"
                >是</el-button>
                <el-button
                  type="info"
                  icon="el-icon-circle-close-outline"
            ...
            <el-col :span="24" v-if="editType !='add'">
              <el-form-item>
                <el-button
                  ...
                  plain
                  v-showPicture
                  :imgurl="templateModel.qrUrl ? templateModel.qrUrl : defaultImg"
                >二维码接单地址</el-button>
                <el-button
                  type="primary"
                  plain
                  v-showPicture
                  :imgurl="templateModel.shipperQrUrl ? templateModel.shipperQrUrl : defaultImg"
                >查看货主邀请码</el-button>
                <el-button
                  type="primary"
                  plain
                  v-showPicture
                  :imgurl="templateModel.driverQrUrl ? templateModel.driverQrUrl : defaultImg"
                >查看车主邀请码</el-button>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-table style="width: 100%;min-height:0px">
              <el-table-column prop label="中单等级"></el-table-column>
              <el-table-column prop label="奖励等级"></el-table-column>
              <el-table-column prop label="抽佣等级"></el-table-column>
              <el-table-column prop label="提现等级"></el-table-column>
            </el-table>
          </el-row>
          <!-- 冻结信息 -->
          <el-row v-if="editType=='view'">
            ...
            <el-table style="width: 100%;min-height:0px" :data="templateModel.aflcFreezeUserList">
              ...
              <el-table-column prop="freezeCause" label="原因" show-overflow-tooltip></el-table-column>
              <el-table-column prop label="解冻日期" show-overflow-tooltip>
                <template slot-scope="scoped">{{scoped.row.unfreezeTime|parseTime}}</template>
              </el-table-column>
              <el-table-column prop label="说明" show-overflow-tooltip>
                <template
                  slot-scope="scoped"
                >{{scoped.row.freezeType=="2"?scoped.row.unfreezeCauseRemark:scoped.row.freezeCauseRemark}}</template>
              </el-table-column>
              <el-table-column prop label="操作时间" show-overflow-tooltip>
                <template slot-scope="scoped">{{scoped.row.createTime|parseTime}}</template>
              </el-table-column>
          ...
          <el-row v-if="editType=='view'">
            ...
            <el-table style="width: 100%;min-height:0px" :data="templateModel.aflcBlackUserList">
              ...
              <el-table-column prop label="原因" show-overflow-tooltip>
                <template
                  slot-scope="scoped"
                >{{scoped.row.blackType=="1"?scoped.row.outPutBlackCauseRemark:scoped.row.putBlackCauseRemark}}</template>
              </el-table-column>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          plain
          icon="el-icon-error"
          @click="driverTemplateDialogFlag=false"
        >取 消</el-button>
      </div>
    </el-dialog>
...
<script>
import {
  data_get_driverName_id,
  data_post_checkDriverCarNumber,
  data_get_shipper_carOwner,
  data_post_createDriver,
  data_post_mobileGetDriver,
  data_post_driverAudit,
  data_put_changeDriver,
  data_post_audit
} from "@/api/users/carowner/all_car.js";
...
export default {
  ...
  props: {
    ...
    // edit已认证车主修改 需校验，edit2 未认证/认证不通过车主修改不校验 ,valetAuth_up 认证不通过车主 代客认证，valetAuth_un 未认证车主代客认证
    editType: {
      type: String,
      default: ""
    },
  ...
  watch: {
    driverTemplateDialogFlag: {
      handler: function(val, oldVal) {
        if (!val) {
          this.templateModel = this.$options.data().templateModel;
  ...
  methods: {
    carNumberValidator(rule, val, cb) {
      var _this = this;
      ...
      if (!val) {
        ...
        data_post_checkDriverCarNumber(_this.DriverCarNumFrom)
          ...
          .catch(err => {
            cb(new Error(err.errorInfo || err.text));
          });
      }
    },

    // 车长宽高校验
    carBreadth(rule, val, cb) {
      var reg = /^[0-9]+(.[0-9]{1,2})?$/;
      if (!val) {
        cb(new Error("不能为空"));
      ...
      if (this.editType == "view") {
        data_get_driverName_id(this.paramsView.driverId)
          .then(res => {
            ...
            if (this.driverStatus == "AF0010401") {
              this.templateModel.driverPermit = this.$options.data().templateModel.driverPermit;
            } else {
              this.expands.push(res.data.driverPermitList[0].id);
            }
          ...
          if (!this.params) {
            ...
            data_get_driverName_id(this.params[0].driverId)
              .then(res => {
                ...
                this.DriverCarNumFrom.carNumber = res.data.carNumber;
                if (
                  this.driverStatus !== "AF0010401" &&
                  res.data.driverPermitList
                ) {
                  this.expands.push(res.data.driverPermitList[0].id);
                } else {
                  // this.templateModel.driverPermit = this.$options.data().templateModel.driverPermit;
                ...
                if (this.templateModel.aflcBusinessInformationList.length > 0) {
                  this.templateModel.aflcBusinessInformationList.forEach(
                    item => {
                      item.updateTime = parseTime(
                        item.updateTime,
                        "{y}-{m}-{d} {h}:{i}:{s}"
    ...
    showCurrenPic(type, index) {
      ...
      switch (type) {
        ...
        case "drivingPermitFile":
          this.signImages = this.templateModel.driverPermitList
            ? this.templateModel.driverPermitList[index].drivingPermitFile
            : this.templateModel.drivingPermitFile;
          break;
        case "drivingPermitFileOpposite":
          this.signImages = this.templateModel.driverPermitList
            ? this.templateModel.driverPermitList[index]
                .drivingPermitFileOpposite
            : this.templateModel.drivingPermitFileOpposite;
          break;
        case "carFile":
          this.signImages = this.templateModel.driverPermitList
            ? this.templateModel.driverPermitList[index].carFile
            : this.templateModel.carFile;
          break;
      }
    ...
    drivingLicenceFileInmation(val) {
      ...
      if (val.vldEnd.toString().indexOf("年") !== -1) {
        ...
        this.$set(
          this.templateModel,
          "vldEndLicence",
          new Date(newVldEndArarry).getTime()
        );
      } else {
    ...
    drivingPermitFileInmation(val) {
      if (this.editType == "add" || this.driverStatus == "AF0010401") {
        ...
        this.templateModel.driverPermitList[0].carNumber = val.carNumber;
        this.templateModel.driverPermitList[0].owner = val.owner;
        this.templateModel.driverPermitList[0].useType = val.useType;
        this.templateModel.driverPermitList[0].brandType = val.brandType;
        this.templateModel.driverPermitList[0].vin = val.vin;
        this.templateModel.driverPermitList[0].engineNo = val.engineNo;
        this.templateModel.driverPermitList[0].fileNumber = val.fileNumber;
        this.$set(
          this.templateModel.driverPermitList[0],
          "registerDate",
          val.registerDate
        );
        this.$set(
    ...
    rowClick(row, column, event) {
      let i = this.expands.findIndex((value, index) => {
        return value == row.id;
      });
      if (i == -1) {
    ...
    handleClick(type, index) {
      switch (type) {
        ...
        case "conserve":
          let pass = false;
          let newForm = this.templateModel.aflcBusinessInformationList[
            this.templateModel.aflcBusinessInformationList.length - 1
          ];
          if (
            newForm.userStatus == "" ||
            newForm.groupCode == "" ||
    ...
    getCustomer1(val, key) {
      this.templateModel.aflcBusinessInformationList[
        key
      ].belongCustomerService = val.name;
      this.templateModel.aflcBusinessInformationList[
        key
      ].belongCustomerServiceId = val.userId;
    },
    getReturnBelong(val, key) {
      this.templateModel.aflcBusinessInformationList[key].belongSalesmanName =
        val.name;
      this.templateModel.aflcBusinessInformationList[key].belongSalesman =
        val.userId;
      this.templateModel.aflcBusinessInformationList[key].belongSalesmanMobile =
        val.mobile;
    },
    getObject(i, e) {
    ...
    ChangeData() {
      if (this.editType == "edit2") {
        ...
        this.templateModel.driverPermit = this.templateModel.driverPermitList[0];
        this.templateModel.carType = this.templateModel.driverPermitList[0].carType;
        this.templateModel.carNumber = this.templateModel.driverPermitList[0].carNumber;
            ...
            if (valid) {
              if (this.chooseType) {
                ...
                if (this.btnStatus) {
                  ...
                  if (this.editType === "add") {
                    for (let i in this.templateModel.driverPermit) {
                      this.templateModel.driverPermit[i] = this.templateModel[
                        i
                      ];
                    }
