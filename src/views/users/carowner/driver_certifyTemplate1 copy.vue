          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="行驶证注册日期：" :label-width="formLabelWidth">
                <el-date-picker v-model="templateModel.registerDate" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="行驶证发证日期：" :label-width="formLabelWidth">
                <el-date-picker v-model="templateModel.issueDate" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
