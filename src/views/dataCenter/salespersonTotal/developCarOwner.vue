<template>
  <div class="identicalStyle developCarOwner" style="height:100%" v-loading="loading">
    <el-form :inline="true" class="demo-ruleForm classify_searchinfo">
      ...
      <el-form-item label="认证状态">
        <el-select v-model="searchInfo.driverStatus" clearable placeholder="请选择" disabled>
          <el-option
    ...
    <div class="classify_info">
      ...
      <div class="info_news">
        ...
        >
          ...
          <el-table-column label="手机号码" prop="driverMobile" show-overflow-tooltip min-width="120">
            <template slot-scope="scope">
              <h4
                class="needMoreInfo"
                @click="pushUserDetail(scope.row)"
              >{{ scope.row.driverMobile}}</h4>
            </template>
          </el-table-column>
          <el-table-column
            label="车牌号"
...
import { findSalesmanDriverDevelopDetailList } from "@/api/dataCenter/salespersonTotal/developTotal.js";
export default {
  data() {
    return {
      loading: true,
      ...
      searchInfo: {
        driverStatus: this.$route.query.status,
  ...
  methods: {
    ...
    firstblood() {
      this.loading = true;
      findSalesmanDriverDevelopDetailList(
        this.page,
        this.pagesize,
        this.searchInfo
      )
