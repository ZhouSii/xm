        ...
        <div class="side_right_bottom clearfix">
          <div class="btns_box clearfix">
            <el-button
              ...
              v-has:SYSTEM_SALESMANEXAMINATION_SALESMANQUESTIONBANK_ADD
              >新增题目</el-button
            >
            <el-button
              type="primary"
              ...
              v-has:SYSTEM_SALESMANEXAMINATION_SALESMANQUESTIONBANK_MODIFY
              >修改题目</el-button
            >
            <el-button type="primary" size="mini" plain @click="del(selected)" 
              v-has:SYSTEM_SALESMANEXAMINATION_SALESMANQUESTIONBANK_DELETE
              >删除题目</el-button
            >
            <el-button
              type="primary"
              ...
              v-has:SYSTEM_SALESMANEXAMINATION_SALESMANQUESTIONBANK_SEE
              >预览题目</el-button
            >
          </div>
          <div class="info_news">
      ...
      this.$refs["formData"].validate(valid => {
        if (valid) {
          ...
          if (this.btntitle === "新增") {
            ...
            fetch({
              url: `/${this.$cms}/usercenter/aflcsalesmanlearningquestion/v1/batchAdd`,
              method: "post",
              data: params
            })
              .then(res => {
            ...
            fetch({
              url: `/${this.$cms}/usercenter/aflcsalesmanlearningquestion/v1/update`,
              method: "post",
              data: parm
            })
              .then(res => {
    ...
    del(item) {
      ...
      this.$confirm("此操作将删除选择的数据, 是否确定删除?", "提示", {
        ...
        .then(() => {
          this.loading = true;
          fetch({
            url: `/${this.$cms}/usercenter/aflcsalesmanlearningquestion/v1/delete/${item.id}`,
            method: "get",
            data: {}
          })
            .then(res => {
