<template>
    <div class="identicalStyle partFour" v-loading="loading">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.expensesDetails">
                                <p v-for="(item,idx) in scope.row.expensesDetails" :key="idx">
                                    <!-- {{idx>0?'，':''}} -->
        ...
        return {
            ...
            listSystemObj:{
                ...
                "vo": {
                    ...
                    applyUserType:'AF00113',//申请用户类型(AF00112:区代向专线申请，AF00113:专线向区代申请)
                }
            },
            tableData: [],
