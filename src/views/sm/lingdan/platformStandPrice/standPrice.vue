<template>
    <div class="identicalStyle otherServiceStandPrice" v-loading="loading">
        <div class="classify_info">
            <div class="btns_box">
                <el-button type="primary" icon="el-icon-edit-outline" plain @click="handleClick('maintain')" :size="btnsize" v-has:SERVICE_DISTRICTSALESPRICING_ADDEDSERVICES_ADDEDSERVICES_MODIFY>维护标准定价</el-button>
            </div>
            <div class="info_news">
                <el-table
                    ref="multipleTable"
