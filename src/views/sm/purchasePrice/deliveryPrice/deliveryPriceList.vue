    ...
    <div class="classify_info">
      <div class="btns_box">
        <el-button
          ...
          :size="btnsize"
          v-has:SERVICE_SPECIALLINEPURCHASEPRICING_DELIVERYFEEPRICING_DELIVERYFEEPRICING_ADD
        >新增</el-button>
        <el-button
          type="primary"
          :size="btnsize"
          ...
          v-has:SERVICE_SPECIALLINEPURCHASEPRICING_DELIVERYFEEPRICING_DELIVERYFEEPRICING_MODIFY
        >修改</el-button>
        <el-button
          type="primary"
          :size="btnsize"
          ...
          v-has:SERVICE_SPECIALLINEPURCHASEPRICING_DELIVERYFEEPRICING_DELIVERYFEEPRICING_ENABLEDISABLE
        >启用/禁用</el-button>
        <el-button
          type="primary"
          ...
          :size="btnsize"
          v-has:SERVICE_SPECIALLINEPURCHASEPRICING_DELIVERYFEEPRICING_DELIVERYFEEPRICING_BATCHIMPORT
        >批量导入</el-button>
        <el-button
          type="primary"
          icon="el-icon-upload"
          ...
          :size="btnsize"
          v-has:SERVICE_SPECIALLINEPURCHASEPRICING_DELIVERYFEEPRICING_DELIVERYFEEPRICING_EXPORT
        >导出</el-button>
        <el-button
          type="primary"
          ...
          :size="btnsize"
          v-has:SERVICE_SPECIALLINEPURCHASEPRICING_DELIVERYFEEPRICING_DELIVERYFEEPRICING_DOWNLOADIMPORTTEMPLATE
        >下载导入摸板</el-button>
      </div>
      <div class="info_news">
        <el-table
        ...
        >
          ...
          <el-table-column sortable prop="flag" label="状态" min-width="150">
            <template slot-scope="scope">{{ scope.row.flag == '0' ? '禁用' : '启用' }}</template>
          </el-table-column>
      ...
      if (
        ...
        switch (type) {
          ...
          case "download":
            ...
            deliveryPriceTemplateExcel("1").then(res => {
